					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">  Consultez les historiques de connexion utilisateur</li>
							</ol>
						</nav>
					</div>
						...
						<div class="table-responsive">
							<table id="example" class="table  table-bordered table-hover " style="width:100%">
                                ...
                                $historique_connexion_liste = $sql -> historique_connexion_liste();
                                    while($row =  $historique_connexion_liste->fetch()):
                                    ?>
									<tr>
										<td><?= $row['id'];?></td>
										<td><?= $row['username']; ?></td>
