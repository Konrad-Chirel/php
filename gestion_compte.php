<?php
    ...
    require_once("verification_compte.php");
     ...
     <main class="page-content">
        <!--breadcrumb-->
           ...
           <div class="container-fluid ">
            <!-- Display Bootstrap alerts here -->
        
            <?php
// Vérifiez si un message d'erreur est présent dans la session
if (isset($_SESSION['error_message']) && !empty($_SESSION['error_message'])) {
    $error_message = $_SESSION['error_message'];
    $error_type = isset($_SESSION['error_type']) ? $_SESSION['error_type'] : "alert-danger";
?>

<div id="errorAlert" class="alert <?php echo $error_type; ?> alert-dismissible fade show" role="alert">
...
?>
           ...
           <div class="row align-items-center">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <button type="button" class="btn btn-sm  btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalDefault">Ajouter un nouvel utilisateur</button>
                    <div class="modal fade" id="exampleModalDefault" tabindex="-1">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Assistant de création compte</h5>
                    ...
                    <div class="row g-2">
                        ...
                        <input type="submit" class="btn btn-primary"name="add" value="Ajouter">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer l'assistant</button>
							...
							<table id="example" class="table  table-bordered table-hover " style="width:100%">
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <?php if($status==1) :?>
                                        <td>
                                        <a href="?bloquer=<?= $row['id']; ?>"class="btn btn-danger"><i class="fa fa-lock"></i></a>
                                        <a href="modifier_compte.php?mod=<?= $row['id']; ?>" class="btn btn-info" ><i class="fa fa-edit"></i></a>
                                      <?php else: ?>
                                        <td>
                                        <a  href="?debloquer=<?= $row['id'];?>" class="btn btn-success" ><i class="fa fa-unlock"></i></a>
                                        <a href="modifier_compte.php?mod=<?= $row['id']; ?>" class="btn btn-info" ><i class="fa fa-edit"></i></a>   
                                    </td>
                                         <?php endif?>
                                        </tr>
