      ...
      <aside class="sidebar-wrapper">
          <div class="sidebar-header">
            ...
            <div class="logo-name flex-grow-1">
              <h5 class="mb-0">  <h5 class="mb-0"><?= $_SESSION['username']; ?></h5></h5>
            </div>
     ...
     <main class="page-content">
        <!--breadcrumb-->
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"> Gestion des rôles d'utilisateurs</li>
							</ol>
						</nav>
					</div>
           ...
           <div class="row align-items-center">
                <div class="col-md-6 ">
                <h6 class="mb-0 ">Liste des utilisateurs du système</h6> 
                </div>
							...
							<table id="example" class="table  table-bordered table-hover " style="width:100%">
								<thead>
									<tr>
										...
										<th class="text-uppercase">DROITS D'ACCès</th>
                                ...
                                $admin_liste = $sql -> admin_liste();
                                    while($row = $admin_liste->fetch()):
                                    ?>
									<tr>
										<td><?= $row['id'];?></td>
										<td><?= $row['username']; ?></td>
										<td>
                                            <a href="droits.php?utm=<?= $row['id']; ?>"><i class="fa fa-law"></i>Attribuer les droits</a>
                                        </td>
